...
export const COMMANDS = new Set([
  ...
  'workcell.commissioning.refresh', 'workcell.commissioning.inspect', 'workcell.commissioning.prepare', 'workcell.commissioning.approve', 'workcell.commissioning.stop',
  'workcell.commissioning.recoveryInspect', 'workcell.commissioning.recoveryConfirm',
...
export function unavailableSnapshot(previous = {}) {
  ...
  return {
    ...
    activeCommissioning: (previous.activeCommissioning ?? []).map((owner) => ({ ...owner, statusUnavailable: true, canStop: false,
      recoveryView: owner.recoveryView ? { ...owner.recoveryView, available: false, fresh: false, receivedAt: null, recoveryAvailable: false, recoveryFresh: false, recoveryReceivedAt: null } : undefined })),
